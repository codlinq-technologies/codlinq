...
// import bgImage1 from "../assets/footer1.png";
// import bgImage2 from "../assets/footer2.png";
...
//         src={bgImage1}
//         alt="Decorative Left"
//         className="absolute top-0 left-0 w-40 md:w-72 opacity-10 md:opacity-20 blur-sm"
//       />
//       <img
//         src={bgImage2}
//         alt="Decorative Right"
//         className="absolute top-0 right-0 w-40 md:w-72 opacity-10 md:opacity-20 blur-sm"
//       />
...
//               At Codlinq, we specialize in Software, Website, and Application Development, along with UI/UX Design, Logo Design, and Graphic Design. We combine technical expertise and creative design to deliver scalable, user-friendly, and visually engaging digital solutions. From development to maintenance and testing, our goal is to help businesses connect, create, and conquer in the digital world.
//             </p>
...
//                   className="w-10 h-10 bg-blue-100 dark:bg-[#333] rounded-full flex items-center justify-center hover:bg-[#ff7722] dark:hover:bg-[#ff7722] transition transform hover:scale-110"
//                 >
//                   <FaTwitter className="text-xl text-[#2c2c2c] dark:text-white" />
//                 </a>
//               </div>
//             </div>
//           </div>
...
//                 </li>
//                 <li>
//                   <a href="#services" className="hover:text-[#ff7722] transition">
//                     Services
//                   </a>
//                 </li>
//                 <li>
//                   <a href="#projects" className="hover:text-[#ff7722] transition">
//                     Projects
//                   </a>
//                 </li>
//                 <li>
//                   <a href="#contact" className="hover:text-[#ff7722] transition">
//                     Contact
//                   </a>
//                 </li>
//               </ul>
...
//               <ul className="space-y-2 text-sm text-gray-800 dark:text-gray-300">
//                 <li><a href="#" className="hover:underline transition">Software Development</a></li>
//                 <li><a href="#" className="hover:underline transition">Website Development</a></li>
//                 <li><a href="#" className="hover:underline transition">Application Development</a></li>
//                 <li><a href="#" className="hover:underline transition">Maintenance & Testing</a></li>
//                 <li><a href="#" className="hover:underline transition">UI/UX Design</a></li>
//                 <li><a href="#" className="hover:underline transition">Graphic & Logo Design</a></li>

//               </ul>
//             </div>
//             <div>
//               <h3 className="font-semibold text-[#ff7722] mb-3 ">Help & Support</h3>
//               <ul className="space-y-2 text-sm text-gray-800 dark:text-gray-300">
...
//                 <li><a href="#" className="hover:underline transition">Cookie Policy</a></li>
...
//           <a
//             href="https://portfolio-blush-nu-17.vercel.app/"
//             className="text-[#ff7722] dark:text-[#ff7722] font-bold hover:underline"
//             target="_blank"
//             rel="noopener noreferrer"
//           >
//             Ashutosh Soni
