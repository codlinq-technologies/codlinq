...
//   return (
//     <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white dark:bg-[#1e1e1e] transition-colors duration-300">
//       {/* Rotating orange circle */}
//       <motion.div
//         className="w-16 h-16 border-4 border-[#ff7722] border-t-transparent rounded-full"
//         animate={{ rotate: 360 }}
...
//       {/* Company Name */}
//       <motion.h2
//         className="mt-6 text-2xl font-bold text-[#ff7722] tracking-wide"
