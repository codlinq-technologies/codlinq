...
//     message:
//       "I used to dread doing my tasks every year, but Codlinq made the process so much simpler and stress-free.",
//   },
//   {
//     name: "Sofia L.",
//     role: "Marketing Head",
...
//     >
//       {/* Section Heading */}
//       <h2 className="text-4xl font-bold text-center mb-12 text-[#ffffff]">
//         Testimonials
//       </h2>
...
//             <button
//               onClick={prevSlide}
//               className="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-100 text-white hover:bg-[#7B61FF] hover:text-white transition"
//             >
//               <FaArrowLeft />
//             </button>
//             <button
...
//         <div className="md:w-1/2 flex justify-center items-center relative overflow-hidden">
