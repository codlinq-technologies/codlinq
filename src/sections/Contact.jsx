...
//                   <span className="text-lg font-medium">+91 - 9111057961</span>
//                 </div>
//                 <div className="flex items-center gap-4">
...
//               <iframe
//                 title="Prosperity Architect Location"
...
//                 alt="Indian Flag"
//                 className="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-8 object-contain rounded-sm"
//               />
//               <input
//                 type="tel"
//                 name="phone"
//                 placeholder="1234567890"
//                 className="border rounded-md p-3 pl-14 w-full bg-white dark:bg-[#2c2c2c] dark:border-gray-600 dark:text-white"
//                 required
//                 pattern="[0-9]{10}"
...
//             <select
//               name="reason"
//               className={`border rounded-md p-3 w-full bg-white dark:bg-[#2c2c2c] dark:border-gray-600 dark:text-white transition-colors duration-200 ${
...
//               </option>
//               <option value="Software Maintenance and Testing">
